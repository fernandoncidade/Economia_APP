...
> **Observação:** Este repositório refere-se à versão **v0.0.6.0** do Projeto Economia APP. Apoie o projeto e adquira a versão paga através do link: [Instalar via Microsoft Store](https://apps.microsoft.com/detail/9PLR0KD6KSJJ)
...
> **Note:** This repository refers to the **v0.0.6.0** version of the Economia APP Project. Support the project and purchase the paid version through the link: [Instalar via Microsoft Store](https://apps.microsoft.com/detail/9PLR0KD6KSJJ)
