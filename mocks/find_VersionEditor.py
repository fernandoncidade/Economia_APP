...
FILES_REL = {
    ...
    "eula_pt": Path("source") / "assets" / "EULA" / "EULA_pt_BR - Economia.txt",
    "eula_en": Path("source") / "assets" / "EULA" / "EULA_en_US - Economia.txt",
    ...
    "clc_pt": Path("source") / "assets" / "CLC" / "CLC_pt_BR - Economia.txt",
    "clc_en": Path("source") / "assets" / "CLC" / "CLC_en_US - Economia.txt",
