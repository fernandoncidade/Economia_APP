...
def calculate_caue(self):
    try:
        ...
        steps.append(tr("App", "O objetivo é determinar a vida econômica do ativo, que é o período que resulta no menor") + "\n")
        steps.append(tr("App", "Custo Anual Uniforme Equivalente (CAUE).") + "\n\n")
                ...
                for r_idx, r in enumerate(resultados):
                    if r['ano'] == menor_caue['ano']:
                        for c in range(table_widget.columnCount()):
                            ...
                            if item:
                                item.setBackground(QBrush())  # pode ajustar cor aqui se desejar
            except Exception:
                pass
        ...
        try:
            ...
            # fallback: apenas adicionar o texto
            try:
